...
public class Wave4 extends Wave{
	public Wave4(){
		...
		this.enemies.add(new ConstantXLaser(GameActivity.CAMERA_WIDTH*0.3f, (float) (GameActivity.CAMERA_HEIGHT+50), ConstantXLaser.goUpOrDown.goUp, 0.3f));
		...
		this.enemies.add(new VerticalShooting(GameActivity.CAMERA_WIDTH+600, (float) (GameActivity.CAMERA_HEIGHT*0.8),GameActivity.CAMERA_WIDTH, 0));
		this.enemies.add(new VerticalMovementLaser(GameActivity.CAMERA_WIDTH+600, (float) (GameActivity.CAMERA_HEIGHT*0.6), GameActivity.CAMERA_WIDTH*0.9f));
		this.enemies.add(new VerticalShooting(GameActivity.CAMERA_WIDTH+600, (float) (GameActivity.CAMERA_HEIGHT*0.2),GameActivity.CAMERA_WIDTH, 0));
	}
}
